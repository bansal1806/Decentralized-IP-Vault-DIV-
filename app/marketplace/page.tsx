...
export default function MarketplacePage() {
    const [searchFilteredAssets, setSearchFilteredAssets] = useState<CreativeAsset[]>(MOCK_ASSETS);
    const [displayedAssets, setDisplayedAssets] = useState<CreativeAsset[]>(MOCK_ASSETS);
    ...
    return (
        <div className="container py-8 max-w-screen-2xl mx-auto">
            ...
            <MarketplaceSearch assets={MOCK_ASSETS} onFilteredAssetsChange={handleSearchChange} />
